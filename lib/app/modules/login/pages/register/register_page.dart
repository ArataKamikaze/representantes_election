...
class RegisterPage extends fluent.StatefulWidget {
  const RegisterPage({Key? key}) : super(key: key);

  @override
  fluent.State<RegisterPage> createState() => _RegisterPageState();
}

class _RegisterPageState extends fluent.State<RegisterPage> {
// APENAS TESTES
  @override
